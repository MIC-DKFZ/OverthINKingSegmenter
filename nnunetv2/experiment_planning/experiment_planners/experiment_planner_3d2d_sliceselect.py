...
class ExperimentPlanner3D2DSliceselect(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'Preprocessor3D2DSliceselect', plans_name: str = 'nnUNetPlans',
...
if __name__ == '__main__':
    ExperimentPlanner3D2DSliceselect(760, 8).plan_experiment()
