...
class ExperimentPlanner3D2DInd(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'Preprocessor3D2DInd', plans_name: str = 'nnUNetPlans',
    ...
    def determine_reader_writer(self):
        training_identifiers = get_folder_identifiers_from_splitted_dataset_folder(join(self.raw_dataset_folder, 'imagesTr'))
    ...
    def plan_experiment(self):
        ...
        # yeah actually no, let's still do that
...
if __name__ == '__main__':
    ExperimentPlanner3D2DInd(760, 8).plan_experiment()
