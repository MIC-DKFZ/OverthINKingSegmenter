...
class DatasetFingerprintExtractor3D2DInd(object):
    ...
    def run(self, overwrite_existing: bool = False) -> dict:
        ...
        if not isfile(properties_file) or overwrite_existing:
            ...
            results = ptqdm(DatasetFingerprintExtractor3D2DInd.analyze_case,
...
if __name__ == '__main__':
    dfe = DatasetFingerprintExtractor3D2DInd(763, 1, True)
